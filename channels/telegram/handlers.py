...
async def on_help(message: Message) -> None:
    ...
    lines = [
        ...
        "реквизитам.",
        "— Отсканируйте QR-код в приложении банка и переведите указанную сумму, ничего "
        "больше вводить не нужно.",
        "— Постеры с присвоенными номерами придут автоматически, как только оплата "
        "поступит на расчётный счёт — подтверждать оплату вручную не требуется.",
        "— «Мои покупки» — история покупок и статус счетов (после того как вы поделитесь "
        "контактом).",
        "",
        "Оплата через Т-Банк:",
        "Если переводите из приложения Т-Банка, комиссия за перевод не взимается, а "
        "платёж поступает быстрее, чем из других банков.",
        "",
        "Оплата наличными:",
        "Чтобы оплатить наличными, обратитесь к оператору АЗС «Дизель»: "
