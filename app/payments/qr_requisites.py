...
результата — Windows-1251 (общепринятая практика для банковских приложений,
сканирующих такие QR — см. DECISIONS.md); RECOMENDATION: перед продакшеном
реально отсканировать сгенерированный QR несколькими банковскими приложениями.
"""
...
def build_st00012_payload(
    *,
    ...
    Windows-1251 для самого QR-изображения выполняется отдельно, на шаге рендера
